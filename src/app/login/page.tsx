  ...
  return (
    <main className="h-screen w-screen bg-zinc-800">
      <div className="flex h-full items-center justify-center p-8 md:p-0">
        <article className="flex max-w-[800px] flex-col items-center justify-evenly rounded-xl bg-zinc-700 p-8 md:p-16">
          <div className="flex flex-col items-center justify-center">
            ...
            <span className="text-center text-base font-bold text-zinc-400 md:text-xl">
